document.querySelector(".btnMen").addEventListener("click", function () {
  window.location.href = "women.html";
});
document.querySelector(".btnWomen").addEventListener("click", function () {
  window.location.href = "women.html";
});
...
var womenData = JSON.parse(localStorage.getItem("women")) || [];
